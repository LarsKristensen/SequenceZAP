...
// ZAP: 2014/08/14 Issue 1062: Made clonerequest to also copy history reference 
...
public class HttpMessage implements Message {
    ...
    public HttpMessage cloneRequest() {
        ...
        if (!this.getRequestHeader().isEmpty()) {
            ...
            //ZAP: Copy history reference in order to know what messages are part of a script (HACK)
            newMsg.setHistoryRef(this.getHistoryRef());
